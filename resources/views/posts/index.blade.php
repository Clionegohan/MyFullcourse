...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
        <h1 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white font-serif">みんなのフルコース</h1>
    </div>
        ...
        <div class="lg:w-3/4 grid grid-cols-1 gap-6 max-w-2xl p-6">
            @foreach ($posts as $post)
                ...
                <div class="group flex flex-col bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <!-- Category -->
                    <a href="/categories/{{ $post->category->id }}" class="text-base text-blue-600">{{ $post->category->name_jp }}</a>
